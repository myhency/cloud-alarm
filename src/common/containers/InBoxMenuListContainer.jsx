        ...
        <BaseBox>
            <List>
                ...
                <Collapse in={expandSevenBread} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        ...
                        <MenuListItem
                            ...
                            key={7}
                            onClick={(e) =>
                                handleClick(e, '/service/seven-bread', 7)
                            }
                        >
                            <ListItemIcon>
                                <ListAltIcon />
                ...
                <MenuListItem
                    ...
                    key={6}
                    onClick={(e) =>
                        handleClick(e, '/service/analyze/volume', 6)
                    }
                >
                    <ListItemIcon>
                        <ViewListIcon />
